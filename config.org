...
#+BEGIN_SRC emacs-lisp
  (let ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     ;; erc stuff
     ; TSC `(erc-nick-default-face ((,class :foreground ,blue :background ,background :weight bold)))
...
#+BEGIN_SRC emacs-lisp
  ;; TSC - remove launcher stuff
#+END_SRC

*** Keybindings to start processes
These can be modified as well, suit yourself.
#+BEGIN_SRC emacs-lisp
  ;; TSC - remove key bindings to start stuff
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
;; TSC - (defconst volumeModifier "4")
#+END_SRC

*** Functions to start processes
#+BEGIN_SRC emacs-lisp
  ;; TSC remove audio stuff
#+END_SRC
...
;; from https://github.com/flyingmachine/emacs-for-clojure/blob/master/customizations/setup-clojure.el
...
#+BEGIN_SRC emacs-lisp
      ...
      (global-set-key (kbd "C-S-o") (lambda () (interactive)(beginning-of-line)(open-line 1)))
      (global-set-key (kbd "C-o") (lambda () (interactive)(end-of-line)(newline)))
          ;; scroll one line at a time (less "jumpy" than defaults)
       (setq mac-option-modifier 'super)
       (desktop-save-mode 1)

      ;; I want to hit q to close the help buffer
      (setq help-window-select t)
      ;; TSC - make overwrite mode more pleasant when there is no insert key; insert mode by default
      (add-hook 'overwrite-mode-hook
                (lambda ()
                  (setq cursor-type (if overwrite-mode t 'bar))))
      (overwrite-mode -1)
      (global-set-key (kbd "M-i") (lambda () (interactive) (if overwrite-mode (overwrite-mode -1) (overwrite-mode 1))))

      (use-package dockerfile-mode
        :ensure t
;;        :custom (setq dockerfile-use-sudo t)
      ...
      (use-package docker
        :ensure t
;;        :custom (setq docker-command "sudo docker")
        :bind ("C-c d" . docker))
